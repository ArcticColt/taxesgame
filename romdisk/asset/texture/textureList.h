...
std::unordered_map<std::string, TextureList> textureMeta = {
    ...
    {"pistol", {"pistol", "/rd/asset/texture/pistola.png", 32, 32, PVR_TXRFMT_ARGB1555, 1}},
    {"BGDLevel1", {"BGDLevel1", "/rd/asset/texture/level1Floor.png", 32, 32, PVR_TXRFMT_ARGB1555, 0}},
};